...
public class Chunk {
    ...
    private final ChunkCoordIntPair chunkCoords; // Rinny - cache chunkCoordIntPair
    public Chunk(World world, int i, int j) {
        ...
        this.chunkCoords = new ChunkCoordIntPair(this.locX, this.locZ); // Rinny - cache chunkCoordIntPair
    }
    ...
    public ChunkCoordIntPair l() {
        return this.chunkCoords; // Rinny - cache chunkCoordIntPair
    }
